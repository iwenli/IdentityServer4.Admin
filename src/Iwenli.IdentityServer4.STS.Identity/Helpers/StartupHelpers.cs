...
using Iwenli.IdentityServer4.STS.Identity.Configuration.ApplicationParts;
...
using Iwenli.IdentityServer4.STS.Identity.Helpers.Localization;
using Iwenli.IdentityServer4.STS.Identity.Services;
using System.Linq;
